            ...
            try:
                ...
                if  buildSum == int(dataSet[3]):
                    if int(dataSet[0]) >= 800 and int(dataSet[0]) <= 899: #Client to Client traffic.
                        ...
                        masterTx.put(msg)
                    elif dataSet[0] >> 100 and dataSet[0] << 400: # Inbound data for the Host.
                        #Process it.
                ...
                print "commandHandler: INVALID COMMAND, format error: %r" % msgj
                pass
            finally:
                masterRx.task_done()
