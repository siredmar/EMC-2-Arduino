...
//#if useLimitSwitches
  ...
  void checkSwitches(){
    ...
    int faultCount=0;
        ...
        faultCount+=switchState;
      #else
        if(targetPos[0]>xVirtualHome&&targetPos[0]<(xVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[1]>yVirtualHome&&targetPos[1]<(yVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[2]>zVirtualHome&&targetPos[2]<(zVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[3]>aVirtualHome&&targetPos[3]<(aVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[4]>bVirtualHome&&targetPos[4]<(bVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[5]>cVirtualHome&&targetPos[5]<(cVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[6]>uVirtualHome&&targetPos[6]<(uVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
        ...
        faultCount+=switchState;
      #else
        if(targetPos[7] > vVirtualHome && targetPos[7] < (vVirtualHome+2500))
        {
          switchState = 1;
        }else
        {
        ...
        faultCount+=switchState;
      #else
        if(targetPos[8]>wVirtualHome&&targetPos[8]<(wVirtualHome+2500)){
          switchState=1;
        }else{
          switchState=0;
        }
